...
do
    ...
    echo value of PROCESS_UTIME = ${PROCESS_UTIME} jiffies
    echo value of PROCESS_STIME = ${PROCESS_STIME} jiffies
    echo value of SYSTEM_UPTIME_SEC = ${SYSTEM_UPTIME_SEC} sec
    echo value of PROCESS_STARTTIME = ${PROCESS_STARTTIME} jiffies
